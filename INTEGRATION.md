...
**Last Updated**: 2025-10-15 10:24:23 UTC
**Ruchy Version**: 3.86.0
**Total Demos**: 148 (56 REPL + 92 one-liners)
...
|----------|-------|--------|
| **REPL Demos** | 56 | ✅ Active |
| **One-Liner Demos** | 92 | ✅ Active |
| **Total** | **148** | ✅ **All Active** |

### Quality Metrics
| Metric | Value | Target | Status |
|--------|-------|--------|--------|
| Total Demos | 148 | 200+ | 🟡 In Progress |
...
**Last Run**: 2025-10-15T10:19:17.691Z
...
- **03-data-structures**: 5 demos
- **04-algorithms**: 5 demos
- **05-functional**: 12 demos
- **06-advanced**: 0 demos
- **06-replays**: 1 demos
- **07-tab-completion-test-cases**: 1 demos
- **08-data-science**: 10 demos
- **09-wasm-analysis**: 1 demos

### One-Liner Demos (92)
- **data-analysis**: 14 one-liners
- **data**: 1 one-liners
- **file-operations**: 10 one-liners
- **functional-chains**: 25 one-liners
- **functional**: 1 one-liners
- **math-calculations**: 8 one-liners
- **math**: 2 one-liners
- **system-scripting**: 20 one-liners
- **text-processing**: 10 one-liners
- **text**: 1 one-liners
...
| **Notebook Validation** | ✅ Pass | 100% | Yes |
...
**Last update**: 2025-10-15 10:24:23 UTC
**Ruchy version**: 3.86.0
